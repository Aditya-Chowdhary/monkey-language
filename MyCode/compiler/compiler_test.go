...
func TestCompilerScopes(t *testing.T) {
	...
	globalScopeTable := compiler.symbolTable
	...
	if compiler.symbolTable.Outer != globalScopeTable {
	...
	if compiler.symbolTable != globalScopeTable {
...
func testInstructions(expected []code.Instructions, actual code.Instructions) error {
	...
	if len(actual) != len(concatted) {
		return fmt.Errorf("wrong instruction lengths.\nwant=%q\ngot =%q", concatted, actual)
	}
